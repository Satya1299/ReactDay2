        ...
        <div style={{ textAlign: "center", marginBottom: "3rem" }}>
          ...
          <h1
            style={{
              ...
              background:
                "linear-gradient(90deg,#FF6B6B,#FFE66D,#4ECDC4,#A855F7)",
          ...
          <p style={{ opacity: 0.6 }}>6 interactive animated components</p>
        </div>
...
function Card({ card, setPage }) {
  ...
  return (
    ...
    >
      ...
      <h2 style={{ color: hover ? card.color : "#fff" }}>{card.label}</h2>
